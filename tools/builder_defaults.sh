...
export PFSENSE_DEFAULT_REPO=${PFSENSE_DEFAULT_REPO:-"${PRODUCT_NAME}-repo-devel"}
export PKG_REPO_DEFAULT=${PKG_REPO_DEFAULT:-"${PKG_REPO_BASE}/${PFSENSE_DEFAULT_REPO}.conf"}
export POUDRIERE_PFSENSE_DEFAULT_REPO=${POUDRIERE_PFSENSE_DEFAULT_REPO:-"${PFSENSE_DEFAULT_REPO}"}
